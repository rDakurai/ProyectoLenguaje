...
<div class="d-flex align-items-center justify-content-between mb-3">
  <h1 class="h3 mb-0">{{ $ruta->nombre }}</h1>
  <a class="btn btn-link" href="{{ route('rutas.index') }}">← Volver</a>
</div>

@if($ruta->descripcion)
  <p class="text-secondary">{{ $ruta->descripcion }}</p>
@endif
      ...
      <div class="card-header">
        <ul class="nav nav-tabs card-header-tabs" id="tabParadas" role="tablist">
          <li class="nav-item" role="presentation">
            <button class="nav-link active" id="tab-ida" data-bs-toggle="tab" data-bs-target="#panel-ida" type="button" role="tab">Paradas (Ida)</button>
          </li>
          <li class="nav-item" role="presentation">
            <button class="nav-link" id="tab-vuelta" data-bs-toggle="tab" data-bs-target="#panel-vuelta" type="button" role="tab">Paradas (Vuelta)</button>
          </li>
        </ul>
      </div>
      <div class="card-body">
      ...
      <div class="card-body">
        ...
        @if($horarios->count())
          <div class="table-responsive">
            <table class="table table-sm align-middle" id="tablaHorarios">
              <thead>
                <tr>
                  <th>Día</th>
                  <th>Sentido</th>
